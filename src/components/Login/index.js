...
const renderField=prs=>(
    <input className={validatorClass(prs.meta)} name={prs.name} maxLength={prs.maxLength} {...prs.input} placeholder={prs.placeholder} type={prs.type} />
);
                    ...
                    <form className="signin-form form-horizontal" onSubmit={handleSubmit(this.submitForm)} noValidate>
                        ...
                        <div className="from-group">
                            <div className="input-group">
                                ...
                                <Field name="password" component={renderField} type="email" placeholder="邮箱"/>
                            </div>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            <button disabled={dirty&&invalid} className="btn btn-primary btn-lg btn-block" type="submit">
                                登录
                            </button>
                        </div>
                    </form>
