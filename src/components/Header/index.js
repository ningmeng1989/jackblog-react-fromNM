...
export default class Header extends Component{
    ...
    static propTypes={
        styleMode:PropTypes.string.isRequred,
            ...
            <div className="navbar-box navbar-skin">
                ...
                <div className="nvabar-expanded">
                    ...
                    {(auth.token&&auth.user)?
                        ...
                        :
                        <div>
                            <Link activeClassName="active" className="navtar-item" title="登录" to="/login">
                ...
                <div className="navbar-shrink">
                    ...
                    <a className="pull-right expanded-var angular2" href="//angular2.jackhu.top" title="Angular2.x版">
                    </a>
                </div>
