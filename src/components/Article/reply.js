                ...
                {replys.map((reply,i)=>
                    <div className="reply-item" key={i}>
                        <p className="reply-content">
                            <a className="reply-user link-light">
                                {reply.user_info.nickname}
                            </a>
                            :{reply.content}
                        </p>
                        <div className="reply-footer text-right">
                            <a className="reply" href="javascript:;" onClick={e=>showReply(e,k,reply.user_info.nickname)}>
                                回复
                            </a>
                            <span className="reply-time pull-left">
