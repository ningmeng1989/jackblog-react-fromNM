...
export default class Comment extends Component{
    ...
    handleSubmitReply(e,i,cid){
        ...
        const eleForm=this.refs['reply_from_'+i];
        ...
        return(
            <div className="comment-container clearfix">
                <div className="comment-head clearfix">
                    ...
                    <a href="javascript:;" onClick={e=>this.gotoComment(e)} className="goto-comment pull-right">
                        <i className="fa fa-pencil"></i>添加新评论
                    </a>
                </div>
                <div id="comment_list">
                        ...
                        <div className="comment-item" key={i}>
                            <div className="content">
                                ...
                                <div className="comment-footer text-right">
                                    <a className="reply" href="javascript:;" onClick={e=>this.showReply(e,i,comment.user_id.nickname)}>
                                        回复
                                    </a>
                                </div>
                                <Reply replys={comment.replys} k={i} showReply={this.showReply} />
                                <form className="new-reply hide" ref={'reply_form_'+i} id={'reply_from_'+i} onSubmit={e=>this.handleSubmitReply(e,i,comment._id)}>
                                    <div className="content-text">
                                        <textarea id={'replyContent'+i} maxLength="2000" ref={'replyContent'+i} placeholder="写下你的回复">
                                        </textarea>
                                        <div>
                ...
                {auth.token?
                    <form className="new_comment" onSubmit={e=>submitComment(e,this.state.commentContent)}>
                        <div className="comment-text">
                            <textarea maxLength="2000" required placeholder="写下你的评论..." onChange={this.handleCommentContentChange} id="comment_content">
                            </textarea>
                            <div>
                    ...
                    <div>
                        <p className="comment-signin">
                            <button className="btn btn-info" onClick={openLoginModal}>
                                登录后发表评论
                            </button>
                        </p>
                    </div>
